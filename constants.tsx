...
export const INITIAL_USERS: User[] = [
  { id: '1', name: '超级管理员', email: 'sysadmin@company.com', password: 'admin', role: ['SYSTEM_ADMIN'], department: '架构组', landline: '010-88886666', mobile: '13800000001' },
  { id: '2', name: '审批负责人', email: 'approver@company.com', password: 'admin', role: ['APPROVAL_ADMIN'], department: '行政部', landline: '010-88886667', mobile: '13800000002' },
  { id: '3', name: '李员工', email: 'li@company.com', password: 'user', role: ['EMPLOYEE'], department: '市场部', landline: '010-88886668', mobile: '13800000003' },
];
